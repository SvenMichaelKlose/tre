...
extern treptr trearg_correct (tre_size argnum, unsigned type, treptr, const char * descr);
extern treptr trearg_typed (tre_size argnum, unsigned type, treptr, const char * descr);
