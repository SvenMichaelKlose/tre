...
(defvar *builtins*
	`(APPLY EVAL
      ...
      * / MOD LOGXOR NUMBER?
      ...
      EQ EQL MAKE-SYMBOL MAKE-PACKAGE ATOM SYMBOL-NAME SYMBOL-VALUE %TYPE-ID %%ID
      SYMBOL-FUNCTION %%U=-SYMBOL-FUNCTION SYMBOL-PACKAGE FUNCTION? BUILTIN? MACROP %ATOM-LIST
