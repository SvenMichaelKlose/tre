...
(env-load "stage1/defmacro.lisp" :c :cl)
(env-load "stage1/declare-cps-exception.lisp" :c :cl)
(env-load "stage1/cps-exceptions.lisp")
(env-load "stage1/define-test.lisp" :c :cl)

(env-load "stage1/listp.lisp" :c :cl)
...
(env-load "stage1/defun.lisp" :c :cl)
...
(env-load "stage1/setf-function-p.lisp" :c :cl)
(env-load "stage1/=.lisp")
...
(env-load "stage1/function-source.lisp" :c :cl)
(env-load "stage1/test-lexical-scope.lisp" :c :cl)
